...
- [ ] Unknown QR token → claim flow (creates Container record with unique qrNumber)
- [ ] Known QR token (user's) → opens Container detail showing qrNumber
...
- [ ] Container detail displays both visual token and numeric identifier (qrNumber)
