...
exports.handler = async (event) => {
  ...
  try {
    ...
    const updated = {
      ...
      digestEnabled: input.digestEnabled !== undefined ? input.digestEnabled : profile.digestEnabled,
      digestTime: input.digestTime !== undefined ? input.digestTime : profile.digestTime,
      digestTimezone: input.digestTimezone !== undefined ? input.digestTimezone : profile.digestTimezone,
...
function mapProfileToGraphQL(p) {
  return {
    ...
    digestLastSentAt: p.digestLastSentAt,
