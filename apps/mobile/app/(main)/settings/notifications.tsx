...
function ToggleRow({
  ...
  return (
    ...
    >
      <Text fontSize="$4" color={disabled ? '$text/tertiary' : '$text/primary'} accessible={false}>
        {label}
      </Text>
      <Switch
        value={value}
...
function StepperRow({
  ...
  return (
    <XStack
      ...
      justifyContent="space-between"
    >
      <Text fontSize="$4" color="$text/primary" accessible={false}>
        {label}
      </Text>
      <XStack alignItems="center" gap="$3">
        <Pressable
          ...
          accessibilityLabel={t('accessibility.stepperDecrement', { field: label })}
        >
          <Text fontSize="$5" color="$brand/primary" paddingHorizontal="$3" accessible={false}>
            −
          </Text>
        </Pressable>
        <Text
        ...
        <Pressable
          ...
          hitSlop={8}
          accessibilityRole="button"
          accessibilityLabel={t('accessibility.stepperIncrement', { field: label })}
        >
          <Text fontSize="$5" color="$brand/primary" paddingHorizontal="$3" accessible={false}>
            +
          </Text>
...
export default function NotificationsScreen() {
  ...
  const stepHour = useCallback(
    (key: 'quietHoursStart' | 'quietHoursEnd', delta: 1 | -1) => {
